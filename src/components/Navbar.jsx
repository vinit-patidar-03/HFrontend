        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900 shadow-md">
            <div className="flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex sm:flex-row gap-2 cursor-pointer flex-col-reverse items-end sm:items-center" onClick={() => setIsOpen(prev => !prev)}>
                    ...
                    {user && <img className="h-8" src={user?.picture} alt="" />}
                </div>
                {isOpen && <div className=" w-32 h-32 absolute top-20 mt-1 z-10 right-3 bg-white flex justify-center items-center rounded-lg shadow-[0_0px_3px_rgba(0,0,0,0.3)]">
